...
void AddFrame(pybind11::module& m)
{
    pybind11::class_<Frame>(m, "Frame",
        ...
        .def("__init__",
            ...
            - time_interval_in_seconds : The time interval in seconds (default is 1.0 / 60.0).
        )pbdoc",
             pybind11::arg("index") = 0,
             pybind11::arg("time_interval_in_seconds") = 1.0 / 60.0)
        .def_readwrite("index", &Frame::index,
                       R"pbdoc(
            Index of the frame
        )pbdoc")
        .def_readwrite("time_interval_in_seconds",
                       &Frame::timeIntervalInSeconds,
                       R"pbdoc(
            Time interval of the frame in seconds
        )pbdoc")
        .def("time_in_seconds", &Frame::TimeInSeconds,
             R"pbdoc(
