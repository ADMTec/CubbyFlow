    ...
    pybind11::class_<VolumeGridEmitter2, VolumeGridEmitter2Ptr, GridEmitter2>(
        ...
        .def("__init__",
            ...
            Constructs an emitter with a source and is-one-shot flag.
             ...
             pybind11::arg("source_region"),
             pybind11::arg("is_one_shot") = true)
        .def("add_signed_distance_target",
             &VolumeGridEmitter2::AddSignedDistanceTarget,
             R"pbdoc(
            Adds signed-distance target to the scalar grid.
        )pbdoc",
             pybind11::arg("scalar_grid_target"))
        .def("add_step_function_target",
            ...
            Parameters
            ----------
            - scalar_grid_target : The scalar grid target.
            - min_value : The minimum value of the step function.
            - max_value : The maximum value of the step function.
        )pbdoc",
             pybind11::arg("scalar_grid_target"), pybind11::arg("min_value"),
             pybind11::arg("max_value"))
        .def("add_target",
            ...
            Parameters
            ----------
            - grid_target : The scalar/vector grid target.
            - custom_mapper : The custom mapper.
        )pbdoc",
             pybind11::arg("grid_target"), pybind11::arg("custom_mapper"))
        .def_property_readonly("source_region",
                               &VolumeGridEmitter2::GetSourceRegion,
                               R"pbdoc(
            Implicit surface which defines the source region.
        )pbdoc")
        .def_property_readonly("is_one_shot", &VolumeGridEmitter2::GetIsOneShot,
                               R"pbdoc(
...
void AddVolumeGridEmitter3(pybind11::module& m)
{
    pybind11::class_<VolumeGridEmitter3, VolumeGridEmitter3Ptr, GridEmitter3>(
        ...
        .def_property_readonly("is_one_shot", &VolumeGridEmitter3::GetIsOneShot,
                               R"pbdoc(
            True if this emits only once.
        )pbdoc");
}