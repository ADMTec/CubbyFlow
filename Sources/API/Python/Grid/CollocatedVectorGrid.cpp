...
void AddCollocatedVectorGrid2(pybind11::module& m)
{
    pybind11::class_<CollocatedVectorGrid2, CollocatedVectorGrid2Ptr,
        ...
        .def("curl_at_data_point", &CollocatedVectorGrid2::CurlAtDataPoint,
             R"pbdoc(
			...
			- j : Data point index j.
             ...
             pybind11::arg("i"), pybind11::arg("j"))
        .def("get_data_accessor", &CollocatedVectorGrid2::GetDataAccessor,
             R"pbdoc(
			The data array accessor.
		)pbdoc")
        .def("get_data_position", &CollocatedVectorGrid2::GetDataPosition,
             R"pbdoc(
...
void AddCollocatedVectorGrid3(pybind11::module& m)
{
    pybind11::class_<CollocatedVectorGrid3, CollocatedVectorGrid3Ptr,
        ...
        .def("curl_at_data_point", &CollocatedVectorGrid3::CurlAtDataPoint,
             R"pbdoc(
			Returns curl at data point location.
			...
			- k : Data point index k.
             ...
             pybind11::arg("i"), pybind11::arg("j"), pybind11::arg("k"))
        .def("get_data_accessor", &CollocatedVectorGrid3::GetDataAccessor,
             R"pbdoc(
			The data array accessor.
		)pbdoc")
        .def("get_data_position", &CollocatedVectorGrid3::GetDataPosition,
             R"pbdoc(
			The function that maps data point to its position.
		)pbdoc")
        .def("for_each_data_point_index",
