...
void AddGridFluidSolver2(pybind11::module& m)
{
    pybind11::class_<GridFluidSolver2, GridFluidSolver2Ptr, PhysicsAnimation>(
        ...
        .def_property("gravity", &GridFluidSolver2::GetGravity,
        ...
        .def("get_cfl", &GridFluidSolver2::GetCFL,
			...
			Parameters
			----------
			- time_interval_in_seconds : The time interval in seconds.
		)pbdoc",
             pybind11::arg("time_interval_in_seconds"))
        .def_property("max_cfl", &GridFluidSolver2::GetMaxCFL,
                      &GridFluidSolver2::SetMaxCFL,
                      R"pbdoc(
			The max allowed CFL number.
		)pbdoc")
        .def_property("use_compressed_linear_system",
        ...
        .def_property("advection_solver", &GridFluidSolver2::GetAdvectionSolver,
                      &GridFluidSolver2::SetAdvectionSolver,
                      R"pbdoc(
			The advection solver.
		)pbdoc")
        .def_property("diffusion_solver", &GridFluidSolver2::GetDiffusionSolver,
                      &GridFluidSolver2::SetDiffusionSolver,
                      R"pbdoc(
			The diffusion solver instance.
		)pbdoc")
        .def_property("pressure_solver", &GridFluidSolver2::GetPressureSolver,
                      &GridFluidSolver2::SetPressureSolver,
                      R"pbdoc(
			The pressure solver instance.
		)pbdoc")
        .def_property("closed_domain_boundary_flag",
        ...
        .def_property_readonly("grid_spacing",
                               &GridFluidSolver2::GetGridSpacing,
                               R"pbdoc(
        ...
        .def_property_readonly("grid_origin", &GridFluidSolver2::GetGridOrigin,
                               R"pbdoc(
...
void AddGridFluidSolver3(pybind11::module& m)
{
    pybind11::class_<GridFluidSolver3, GridFluidSolver3Ptr, PhysicsAnimation>(
        ...
        .def_property("gravity", &GridFluidSolver3::GetGravity,
        ...
        .def("get_cfl", &GridFluidSolver3::GetCFL,
             R"pbdoc(
			Returns the CFL number from the current velocity field for given
			time interval.
			...
			- time_interval_in_seconds : The time interval in seconds.
             ...
             pybind11::arg("time_interval_in_seconds"))
        .def_property("max_cfl", &GridFluidSolver3::GetMaxCFL,
        ...
        .def_property("advection_solver", &GridFluidSolver3::GetAdvectionSolver,
                      &GridFluidSolver3::SetAdvectionSolver,
                      R"pbdoc(
			The advection solver.
		)pbdoc")
        .def_property("diffusion_solver", &GridFluidSolver3::GetDiffusionSolver,
                      &GridFluidSolver3::SetDiffusionSolver,
                      R"pbdoc(
			The diffusion solver instance.
		)pbdoc")
        .def_property("pressure_solver", &GridFluidSolver3::GetPressureSolver,
        ...
        .def_property_readonly("grid_spacing",
                               &GridFluidSolver3::GetGridSpacing,
                               R"pbdoc(
			The grid spacing of the grid system data.
        ...
        .def_property_readonly("grid_origin", &GridFluidSolver3::GetGridOrigin,
                               R"pbdoc(
			The origin of the grid system data.
