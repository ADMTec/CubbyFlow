...
void AddGridSmokeSolver2(pybind11::module& m)
{
    pybind11::class_<GridSmokeSolver2, GridSmokeSolver2Ptr, GridFluidSolver2>(
        ...
        .def_property("smoke_diffusion_coefficient",
        ...
        .def_property("temperature_diffusion_coefficient",
        ...
        .def_property("buoyancy_smoke_density_factor",
        ...
        .def_property("buoyancy_temperature_factor",
        ...
        .def_property("smoke_decay_factor",
        ...
        .def_property("smoke_temperature_decay_factor",
        ...
        .def_property_readonly("smoke_density",
